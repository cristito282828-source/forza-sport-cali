...
export default function CheckoutPage() {
  ...
  const handleSubmitOrder = () => {
    if (!cart?.contents.nodes || itemCount === 0) {
    ...
    const phoneNumber = '573118192799';

    // Construir mensaje para WhatsApp
    let message = `*NUEVO PEDIDO - Forza Sport*\n\n`;
    ...
    message += `${formData.direccion}, ${formData.ciudad}\n`;
    message += `Departamento: ${formData.region}\n\n`;
    ...
    message += `\n*TOTAL: ${cart.total}*\n`;
    message += `Pago: ${formData.metodoPago === 'transferencia' ? 'Transferencia' : 'Webpay'}\n\n`;
          ...
          <div className="min-h-[60vh] flex items-center justify-center">
            <div className="text-center max-w-md">
              ...
              <div className="space-y-4">
                ...
                <Link
                  href="/"
                  className="inline-flex items-center text-sm text-gray-900 hover:text-gray-900 transition-colors"
                >
                  Volver al inicio
                </Link>
              </div>
      ...
      <main className="min-h-screen bg-gray-50 pt-36">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <Link
              href="/cart"
              className="inline-flex items-center text-sm text-gray-900 hover:text-gray-900 mb-4 transition-colors"
            >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-700 focus:border-transparent text-gray-900 bg-white"
